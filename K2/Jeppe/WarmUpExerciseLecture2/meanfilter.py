...
if __name__ == "__main__":
    input_image = cv2.imread(
        "K2/Jeppe/WarmUpExerciseLecture2/lion.jpg", flags=cv2.IMREAD_GRAYSCALE
    )
    output_image = meanfilter(input_image, 5)
    cv2.imwrite("K2/Jeppe/WarmUpExerciseLecture2/output.png", output_image)

    ### Testing the solution ###
    desired_image = cv2.imread(
        "K2/Jeppe/WarmUpExerciseLecture2/desired_output.png", flags=cv2.IMREAD_GRAYSCALE
    )
